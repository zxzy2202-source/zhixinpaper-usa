  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        to: [email],
        subject: "Sample Request Received — Zhixin Paper",
        html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-top: none; padding: 24px; border-radius: 0 0 8px 8px;">
            ...
            <p style="color: #1e293b; font-size: 15px; line-height: 1.6;">
              Thank you for requesting samples from Zhixin Paper. We have received your request and will prepare your sample kit within <strong>2–3 business days</strong>.
            </p>
            ...
            <ul style="color: #1e293b; font-size: 15px; line-height: 2;">
              <li>📧 <a href="mailto:Sales@zxpapers.com" style="color: #2563eb;">Sales@zxpapers.com</a></li>
